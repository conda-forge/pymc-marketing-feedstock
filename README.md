About pymc-marketing-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pymc-marketing-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pymc-marketing-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pymc-marketing
# for installing globally
pixi global install pymc-marketing
```
...
It is possible to list all of the versions of `pymc-marketing` available on your platform:
...
```
pixi search pymc-marketing --channel conda-forge
```
